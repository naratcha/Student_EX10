 ...
 * 
 */
@WebServiceClient(name = "StudentWebService", targetNamespace = "http://studentservice/", wsdlLocation = "http://localhost:8080/StudentEX10WebServer/StudentWebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName STUDENTWEBSERVICE_QNAME = new QName("http://studentservice/", "StudentWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/StudentEX10WebServer/StudentWebService?WSDL");
    ...
    public StudentWebService getStudentWebServicePort() {
        return super.getPort(new QName("http://studentservice/", "StudentWebServicePort"), StudentWebService.class);
    }
    ...
    public StudentWebService getStudentWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://studentservice/", "StudentWebServicePort"), StudentWebService.class, features);
    }
